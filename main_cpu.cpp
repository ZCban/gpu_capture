...
py::array_t<float>*        g_result               = nullptr;
...
void cleanup()
{
    ...
    if (pStagingBuffer)        { pStagingBuffer->Release();        pStagingBuffer = nullptr; }
    ...
    if (g_result) { delete g_result; g_result = nullptr; }
}
